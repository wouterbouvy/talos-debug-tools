...
RUN apt-get update && apt-get install --no-install-recommends -y \
    ...
    sg3-utils fdisk gdisk xfsprogs e2fsprogs dosfstools efibootmgr xz-utils lvm2 lm-sensors openssh-server rsync dmidecode thunderbolt-tools libhugetlbfs-bin iperf3 s-tui
RUN apt-get clean
